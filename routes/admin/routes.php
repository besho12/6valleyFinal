...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function () {
    ...
    Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:promotion_management']], function () {
        Route::controller(BusinessSettingsController::class)->group(function () {
            ...
            Route::post(BusinessSettings::SPECIAL_ADS_SETTINGS[URI], 'updateSpecialadsView')->name('specialads');
            Route::get(BusinessSettings::SPECIAL_ADS_SETTINGS[URI].'/{id}', 'editSpecialadsView')->name('editspecialads');
            // Route::patch(BusinessSettings::SPECIAL_ADS_SETTINGS[URI], 'updateSpecialadsView')->name('updatespecialads');
