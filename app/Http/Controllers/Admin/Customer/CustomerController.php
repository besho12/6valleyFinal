...
class CustomerController extends BaseController
{
    ...
    public function update(CustomerUpdateSettingsRequest $request): View|RedirectResponse
    {
        ...
        $this->businessSettingRepo->updateOrInsert(type: 'ads_point_exchange_rate', value: $request->get('ads_point_exchange_rate', getWebConfig('ads_point_exchange_rate')));
        $this->businessSettingRepo->updateOrInsert(type: 'ads_point_minimum_point', value: $request->get('ads_minimun_transfer_point', getWebConfig('ads_point_minimum_point')));
