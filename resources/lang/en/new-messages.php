...
return [
	...
	"in_this_settings_admin_can_set_the_rules_for_the_customers_for_earning_and_use_the_ads_points" => "In this settings admin can set the rules for the customers for earning and use the ads points",
	"ads_Point_Earn_on_Each_Order" => "Ads Point Earn on Each Order",
	"customer_Ads_Point_Settings" => "Customer Ads Point Settings",
	"404_Logs" => "404 Logs",
	...
	"special_ads_settings" => "Special ads settings",
	"special_ads_setup" => "Special ads setup",
];
