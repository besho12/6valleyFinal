...
<div class="inline-page-menu my-4">
    <ul class="list-unstyled">
        ...
        <li class="text-capitalize {{ Request::is('admin/business-settings/specialads') ?'active':'' }}"><a 
                href="{{route('admin.business-settings.specialads')}}">{{translate('special_ads_settings')}}</a>
        </li>
    </ul>
</div>
